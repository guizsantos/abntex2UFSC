...
\hypersetup{%
	pdfcreator={LaTeX}
	,pdfauthor={Guilherme Z. Santos and Júlio César Ferreira}
...
\key[-]{nature of work} Configura a natureza do trabalho, e gera automaticamente o texto da folha de rosto e da folha de aprovação com as informações que são dadas. Aqui são válidas as seguintes chaves:
	\begin{keys}
...
\key[none]{approval sheet text} Guarda o texto que deve ser usado na folha de aprovação, por padrão caso o texto seja \texttt{none} usa-se um texto padrão.
